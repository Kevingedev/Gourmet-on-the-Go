/* admin/components/AddProductModal.js */
    ...
    render: async function () {
        ...
        try {
            ...
            categories.forEach(category => {
                categoryOptions += `<option value="${category.id_categoria}">${category.nombre.ES}</option>`;
            });
        } catch (error) {
        ...
        <div class="modal-content">
            ...
            <form id="productForm">
                <div class="form-group">
                    ...
                    <input type="text" id="productName" name="name" placeholder="Ej. Lomo de Salmón" required>
                </div>
                <div class="form-group">
                    <label for="productDesc">Descripción:</label>
                    <input type="text" id="productDesc" name="description" placeholder="Breve detalle del producto" required>
                </div>
                <div class="form-group">
                    <label for="productUnit">Unidad de medida:</label>
                    <input type="text" id="productUnit" name="unit" placeholder="Ej. 250g, Unidad, Kg" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="featured" id="featured">
                        ...
                        <option value="false" selected>No destacado</option>
                    </select>
                </div>
                <div class="form-group">
        ...
        if (productForm) {
            productForm.onsubmit = async (e) => {
                ...
                const totalProducts = await productsService.getProductsLength();
                ...
                const id_producto = totalProducts + 1;
