...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let btnSesion;
    let wellcome = {
        ES: `Hola <strong>${!currentUserData.username ? 'Usuario Invitado' : currentUserData.username }  </strong> te damos la Bienvenida a Gourmet on the Go!`,
        EN: `Hello <strong>${!currentUserData.username ? 'Guest User' : currentUserData.username}</strong> we welcome you to Gourmet on the Go!`
    };
