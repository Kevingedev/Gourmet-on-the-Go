...
function inicializarBotonesCarrito() {
    // Esperar un poco para asegurar que cartView.js esté listo
    setTimeout(() => {
        const containerProducts = document.querySelector('.container-products');
        
        if (containerProducts) {
            // El event listener ya debería estar en cartView.js, pero lo agregamos aquí también por si acaso
                    ...
                    try {
                        ...
                        if (products) {
                            ...
                            if (cartDrawerContainer) {
                                ...
                                // Llamar a uploadItems si existe (está definida en cartView.js)
                                if (window.uploadItems) {
                                    window.uploadItems(products, cartDrawerContainer);
                                } else {
                                    // Si no existe, crear una función simple para actualizar
                                    actualizarCarrito(products, cartDrawerContainer);
                                }
...
function actualizarCarrito(products, container) {
    container.innerHTML = '';
