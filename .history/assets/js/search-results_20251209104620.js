...
function inicializarBotonesCarrito() {
    // Usar event delegation en el contenedor para que funcione con productos dinámicos
    const containerProducts = document.querySelector('.container-products');
    
    if (containerProducts) {
        // Remover listeners anteriores si existen
        const nuevoContainer = containerProducts.cloneNode(true);
        containerProducts.parentNode.replaceChild(nuevoContainer, containerProducts);
        
        // Agregar el event listener al contenedor
        nuevoContainer.addEventListener('click', async (event) => {
            if (event.target.classList.contains('btn-add-to-cart')) {
                ...
                try {
                    ...
                    if (products) {
                        // Actualizar el drawer del carrito si existe
                        ...
                        if (cartDrawerContainer && typeof uploadItems === 'function') {
